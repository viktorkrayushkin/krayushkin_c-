...
public:
    ...
    {
        std::cout << "Ellipse, equation: (x/"<< a << ")^2 + (y/" << b <<")^2 = 1" << std::endl;
    }
...
public:
    explicit Triangle(const double& a1, const double& a2, const double& a3): a1(a1),a2(a2),a3(a3), Polygon(3){}

    void Figure_info() final
    {
        std::cout << "Triangle, sides are equal to "<< a1 << " " << a2 << " " << a3 <<std::endl;
    }
    void Perimeter() final
    {
...
public:
    explicit Quadrangle(const double& a1, const double& a2,
                        const double& a3, const double& a4): a1(a1),a2(a2),a3(a3),a4(a4),Polygon(4){}
    virtual void Figure_info() override
    {
        std::cout << "Quadrangle "
                     " sides are equal to "<< a1 << ", "<< a2 << ", " << a3 << ", " << a4 << std::endl;
    }
...
public:
    explicit Rectangle(const double& a1, const double& a2): Quadrangle(a1, a2, a1, a2){}
